...
export type ConnectOptions<config extends Config, context = unknown> = MutationParameter<ConnectData<config, config['connectors'][number], boolean>, ConnectErrorType, ConnectVariables<config, config['connectors'][number], boolean>, context>;
export declare function connectMutationOptions<config extends Config, context>(config: config, options?: ConnectOptions<config, context>): ConnectMutationOptions<config>;
export type ConnectMutationOptions<config extends Config> = MutationOptions<ConnectData<config, config['connectors'][number], boolean>, ConnectErrorType, ConnectVariables<config, config['connectors'][number], boolean>>;
