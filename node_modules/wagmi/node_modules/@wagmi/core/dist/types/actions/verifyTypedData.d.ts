...
export type VerifyTypedDataParameters<typedData extends TypedData | Record<string, unknown> = TypedData, primaryType extends keyof typedData | 'EIP712Domain' = keyof typedData, config extends Config = Config> = UnionCompute<viem_VerifyTypedDataParameters<typedData, primaryType> & ChainIdParameter<config>>;
