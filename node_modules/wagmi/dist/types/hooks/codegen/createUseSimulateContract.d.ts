...
} & UnionExactPartial<SimulateContractParameters<abi, name, args, config, chainId>> & ScopeKeyParameter & ConfigParameter<config> & QueryParameter<SimulateContractQueryFnData<abi, name, args, config, chainId>, SimulateContractErrorType, selectData>) => UseSimulateContractReturnType<abi, name, args, config, chainId, selectData>;
